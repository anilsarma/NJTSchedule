...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickHeaderItemDecoration(Context context,  @NonNull StickyHeaderInterface listener) {
        mListener = listener;
        mDivider = ContextCompat.getDrawable(context, R.drawable.line_divider);
    }

    public void onDrawOver_divier(Canvas c, RecyclerView parent, RecyclerView.State state) {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        onDrawOver_divier(c, parent, state);
